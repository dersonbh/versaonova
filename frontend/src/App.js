    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: "#803fe7" },
                textPrimary: mode === "light" ? "#803fe7" : "#803fe7",
                borderPrimary: mode === "light" ? "#803fe7" : "#803fe7",
                dark: { main: mode === "light" ? "#333333" : "#F3F3F3" },
                light: { main: mode === "light" ? "#F3F3F3" : "#333333" },
                tabHeaderBackground: mode === "light" ? "#EEE" : "#333",
                optionsBackground: mode === "light" ? "#fafafa" : "#333",
				options: mode === "light" ? "#fafafa" : "#666",
				fontecor: mode === "light" ? "#803fe7" : "#fff",
                ...
                inputBackground: mode === "light" ? "#803fe7" : "#333",
                barraSuperior: mode === "light" ? "linear-gradient(to right, #803fe7, #803fe7, #4c1d86)" : "#666",
